...
md`# HW05_HoChePing （何哲平）_MediumBaseline_`
)}
...
function _medium1(d3,simple_data,drag,invalidation)
{
  // 指定圖表的尺寸。
  const width = 500;
  const height = 400;
...
function _medium2_1(d3,simple_data,drag,invalidation)
{
  // 指定圖表的尺寸。
  const width = 500;
  const height = 400;
...
function _medium3_1(d3,simple_data,drag,invalidation)
{
  // 指定圖表的尺寸。
  const width = 500;
  const height = 400;
...
function _medium4_1(d3,simple_data,drag,invalidation)
{
  // 指定圖表的尺寸。
  const width = 500;
  const height = 400;
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["simple.json", {url: new URL("./files/3528468c2efb9de82b7fd5f78ae5b9a280465bcad4b317ad58a88ed132d994589198894011834d9c83d75a963d50803b8e644fc9f70e4caf6e3627b4e1c24776.json", import.meta.url), mimeType: "application/json", toString}],
  ...
  main.variable(observer("medium1")).define("medium1", ["d3","simple_data","drag","invalidation"], _medium1);
  main.variable(observer("medium2_1")).define("medium2_1", ["d3","simple_data","drag","invalidation"], _medium2_1);
  main.variable(observer("medium2_2")).define("medium2_2", ["d3","data","drag","invalidation"], _medium2_2);
  main.variable(observer()).define(["md"], _9);
  main.variable(observer("medium3_1")).define("medium3_1", ["d3","simple_data","drag","invalidation"], _medium3_1);
  main.variable(observer("medium3_2")).define("medium3_2", ["d3","data","drag","invalidation"], _medium3_2);
  main.variable(observer()).define(["md"], _12);
  main.variable(observer("medium4_1")).define("medium4_1", ["d3","simple_data","drag","invalidation"], _medium4_1);
