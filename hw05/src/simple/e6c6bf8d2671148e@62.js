...
md`# HW05_HoChePing （何哲平）_SimpleBaseline_`
)}
...
function _simple1_1(d3,simple,invalidation)
{
   // 指定圖表的尺寸。
  const width = 500;
  const height = 400;
...
function _simple2_1(d3,simple,drag,invalidation)
{
  // 指定圖表的尺寸。
  const width = 500;
  const height = 400;
...
function _simple3_1(d3,simple,drag,invalidation)
{
  // 指定圖表的尺寸。
  const width = 500;
  const height = 400;
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("simple1_1")).define("simple1_1", ["d3","simple","invalidation"], _simple1_1);
  main.variable(observer("simple1_2")).define("simple1_2", ["d3","data","invalidation"], _simple1_2);
  main.variable(observer()).define(["md"], _8);
  main.variable(observer("simple2_1")).define("simple2_1", ["d3","simple","drag","invalidation"], _simple2_1);
  main.variable(observer("simple2_2")).define("simple2_2", ["d3","data","drag","invalidation"], _simple2_2);
  main.variable(observer()).define(["md"], _11);
  main.variable(observer("simple3_1")).define("simple3_1", ["d3","simple","drag","invalidation"], _simple3_1);
