...
md`# HW04_Strong_HoChePing （何哲平）_`
)}
...
<h3>從上圖中，我們可以看出：
  <ol>
    <li> 在這次問卷中，北部的藝術工作者佔比最高，其次則是南部地區。</li>
    <li> 無論工作地點位於哪個區域，參與問卷的藝術工作者中，最多的是那些所在機構以行動或計畫推動永續事務。</li>
    <li> 在北部、南部和東部，那些沒有推動永續事務的工作地點在比例上位居第二（而在中部則是第三），這表明很多藝術工作者的工作場所尚未積極投入永續發展的行動。</li>
  </ol>
</h3>
`
)}
...
d3
  ...
  .range(["#E03C8A","#562E37","#A8497A", "#C1328E","#6D2E5B","#622954", "#72636E"])
  .unknown("#828282")
)}
