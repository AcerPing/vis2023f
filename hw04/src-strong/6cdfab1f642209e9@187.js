...
<h3>從上圖中，我們可以看出：
  <ol>
    <li> 在這份問卷調查中，來自北部地區的人數佔據了大多數。</li>
    <li> 絕大部分填寫此問卷的參與者表示他們有興趣深入了解關於藝術永續的更多資訊。</li>
    <li> 只有一小部分的問卷填寫者表示對於深入瞭解藝術永續相關的資訊缺乏興趣。</li>
    <li> 相比於其他地區，北部地區的居民中有較高比例的人表示不願意，而中部地區則幾乎沒有人表達不願意的意向。</li>
  </ol>
</h3>
`
)}
...
d3
  ...
  .range(["#F596AA", "#62592C", "#EB7A77", "#D0104C", "#CC543A", "#734338"])
  .unknown("#F17C67")
)}
